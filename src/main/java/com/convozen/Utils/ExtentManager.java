...
public class ExtentManager {
    ...
    public static synchronized ExtentReports createInstance(String fileName, String reportName, String documentTitle) {
        ...
        extentSparkReporter.viewConfigurer().viewOrder().as(new ViewName[] {
            ViewName.DASHBOARD, ViewName.TEST, ViewName.CATEGORY,
            ViewName.EXCEPTION, ViewName.DEVICE, ViewName.AUTHOR
        }).apply();
    ...
    public static synchronized ExtentReports getReporter() {
        if (extentReports == null) {
            throw new IllegalStateException("ExtentReports instance not created. Call createInstance() first.");
        }
        return extentReports;
    }
}
